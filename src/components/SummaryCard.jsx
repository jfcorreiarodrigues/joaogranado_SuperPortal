  ...
  return (
    <div className="card flex flex-col p-5 sm:p-6">
      <div className="flex items-center gap-3">
        <div className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl ring-1 ${accents[accent] || accents.emerald}`}>
      ...
      <p
        className={`mt-4 font-extrabold text-slate-50 leading-tight break-words ${
          isLongText ? 'text-xl sm:text-2xl' : 'text-3xl sm:text-4xl'
        }`}
      >
        {value}
      </p>
