...
import { PORTAL_AREAS, addEntry } from '../lib/storage.js'
    ...
    return (
      <div className="card p-8 sm:p-12 text-center">
        <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-emerald-500/20 ring-4 ring-emerald-500/30">
          <CheckCircle2 className="h-12 w-12 text-emerald-400" strokeWidth={2.4} />
        </div>
        <h2 className="mt-6 text-2xl sm:text-3xl font-extrabold text-emerald-300">
          Contacto registado!
        </h2>
    ...
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      ...
      <button
        ...
        className="group flex w-full items-center justify-center gap-3 rounded-2xl
                   bg-emerald-500 px-6 py-5 text-lg font-bold text-slate-950
                   shadow-[0_8px_30px_-8px_rgba(16,185,129,0.6)]
